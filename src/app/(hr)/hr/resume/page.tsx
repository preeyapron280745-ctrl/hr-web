    ...
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">
          รายชื่อผู้สมัครที่แนบ Resume ไว้ในใบสมัคร
        </p>
      </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {forms.map((f) => (
            ...
            >
              ...
              <div className="mt-auto flex gap-2 border-t border-gray-100 bg-gray-50 px-4 py-3">
                <Link
                  href={`/hr/applications/${f.id}`}
                  className="inline-flex flex-1 items-center justify-center gap-1 rounded-lg border border-gray-300 bg-white px-3 py-2 text-xs font-medium text-gray-700 transition-colors hover:bg-gray-100"
                >
                ...
                {f.resumeUrl && (
                  <a
                    ...
                    className="inline-flex flex-1 items-center justify-center gap-1 rounded-lg bg-green-600 px-3 py-2 text-xs font-medium text-white transition-colors hover:bg-green-700"
                  >
